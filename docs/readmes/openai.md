...
This branch is optimized for dual-client usage: Claude Desktop over stdio and ChatGPT Apps over Streamable HTTP, including public tunnel guidance for ChatGPT tool connectivity.
...
### Keep README branch-specific

This repo stores branch README templates in `docs/readmes/`:

- `docs/readmes/main.md`
- `docs/readmes/openai.md`
- `docs/readmes/feature-macos-app.md`

To sync the current branch template into `README.md`:

```bash
npm run readme:sync
```

To verify whether `README.md` is already in sync:
