...
## Branch Focus (feature/macos-app)

This branch is dedicated to the macOS desktop app experience (Electron packaging and launcher flow) while preserving the same Zoom MCP toolset and token automation.
